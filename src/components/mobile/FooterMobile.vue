...
<div v-if="isClicked.info" class="bg-pink-500 border-2 border-white w-full h-1/3 fixed z-20 bottom-0 left-0 mb-[4rem] rounded-[100px] grid">
    <div class="flex flex-col items-center gap-4">
        ...
        <div class="flex justify-center items-center flex-col">
            <img alt="" class="w-28 h-28" src="@/assets/img/logo.svg">
        </div>
        <div class="flex justify-center items-center flex-col">
            <p>Tel : 07 80 75 44 87</p>
            <p>E-mail : sabrina.pinthon@gmail.com</p>
    </div>
</div>
...
<footer class="bg-pink-500 w-full h-12 z-20 fixed bottom-0 left-0">
    <nav class="flex justify-between items-center">
        ...
        <button @click="scrollTop"  class="">
            <svg class="h-12 w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
